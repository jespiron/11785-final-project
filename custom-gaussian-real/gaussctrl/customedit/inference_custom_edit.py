...
def main():
    image_path = "../frames/stone_horse/originalgs/frame_00000.jpg"
    keyword = 'horse'
    prompt = f"a photo of a {keyword} in front of the museum"
    output_folder = './output/edit_stone_horse'
    (image_gt, image_enc), x_t, uncond_embeddings = null_inversion.invert(image_path, prompt, offsets=(0,0,0,0), num_inner_steps=15, verbose=True)
    ...
    # Editing - add token
    prompts = [prompt,
               f"a photo of a <new1> {keyword} in front of the museum"
               ]

    cross_replace_steps = {'default_': .8, }
    self_replace_steps = .6
    blend_word = (((keyword,), (keyword)))
